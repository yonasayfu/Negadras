...
class RoleManagementController extends Controller
{
    ...
    private function permissionDescription(string $permission): string
    {
        return match ($permission) {
            ...
            'applicants.view' => 'Shows presenter applicant profiles in the Negadras admin workspace.',
            'applicants.create' => 'Allows creating applicant profiles when manual intake workflows require it later.',
            'applicants.update' => 'Allows editing applicant profile details and competition contact metadata.',
            'applicants.delete' => 'Allows deleting applicant profiles when cleanup is explicitly required.',
            'organizations.view' => 'Shows organization and team profiles in the Negadras admin workspace.',
            'organizations.create' => 'Allows creating organization or startup profiles and their initial team members.',
            'organizations.update' => 'Allows editing organization metadata, logo files, and team member details.',
            'organizations.delete' => 'Allows deleting organization records when cleanup is explicitly required.',
            'seasons.view' => 'Shows competition seasons and their operational metadata.',
            'seasons.create' => 'Allows creating new competition seasons for Negadras planning.',
            'seasons.update' => 'Allows editing season timing, status, and descriptive details.',
            'seasons.delete' => 'Allows deleting seasons when cleanup or reset actions are required.',
            'stages.view' => 'Shows season stages and their competition ordering.',
            'stages.create' => 'Allows creating new stages within a season.',
            'stages.update' => 'Allows editing stage sequence, timing, and open or closed state.',
            'stages.delete' => 'Allows deleting stages from a season setup.',
            'industries.view' => 'Shows Negadras competition industries or categories.',
            'industries.create' => 'Allows creating new industries for submissions and filtering.',
            'industries.update' => 'Allows editing industry metadata and active state.',
            'industries.delete' => 'Allows deleting industries when they are no longer used.',
            'submissions.view' => 'Shows the Negadras submissions workspace for operational staff and later review roles.',
            'submissions.create' => 'Allows staff-driven submission creation if manual intake or assisted onboarding is required later.',
            'submissions.update' => 'Allows staff to correct or update submissions during intake and screening workflows.',
            'submissions.delete' => 'Allows deleting submission records when cleanup is explicitly approved.',
