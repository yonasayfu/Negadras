...
use App\Policies\JudgeCommentPolicy;
...
use App\Policies\ScoreEntryPolicy;
use App\Policies\ScreeningReviewPolicy;
use App\Policies\SeasonPolicy;
use App\Policies\SessionPresenterPolicy;
use App\Policies\SettingPolicy;
use App\Policies\ShortlistRecordPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    protected function configureDefaults(): void
    {
        ...
        Gate::policy(JudgeComment::class, JudgeCommentPolicy::class);
        Gate::policy(Media::class, MediaPolicy::class);
        Gate::policy(Industry::class, IndustryPolicy::class);
        Gate::policy(Page::class, PagePolicy::class);
        Gate::policy(Panel::class, PanelPolicy::class);
        Gate::policy(ReviewDecision::class, ReviewDecisionPolicy::class);
        ...
        Gate::policy(ScoreEntry::class, ScoreEntryPolicy::class);
        Gate::policy(Setting::class, SettingPolicy::class);
        Gate::policy(ShortlistRecord::class, ShortlistRecordPolicy::class);
