...
import { create as createStage, index as stagesIndex, store as storeStage } from '@/routes/stages';
...
<template>
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <PageContainer>
            <PageHeader
                title="Create stage"
                description="Each stage captures one ordered checkpoint in the season workflow."
            >
                <template #actions>
                ...
                <FormSection>
                    <div class="grid gap-5 md:grid-cols-2">
                        ...
                        <div class="grid gap-2">
                            ...
                            <Input id="name" v-model="form.name" placeholder="Screening" />
                            <InputError :message="form.errors.name" />
                        </div>

                        <div class="grid gap-2">
                            <Label for="code">Code</Label>
                            <Input id="code" v-model="form.code" placeholder="screening" />
